module.exports = router => {
  router.get('*', (req, res) => {
    return res.send('No GET routes implemented yet');
  });
  router.post('*', (req, res) => {
    return res.send('No POST routes implemented yet');
  });
  router.put('*', (req, res) => {
    return res.send('No PUT routes implemented yet');
  });
};
...
studentRouter.post('/api/createStudent', jsonParser, (req, res, next) => {
...
studentRouter.put(
  '/api/teacher/:teacherId/student/:studentId',
  jsonParser,
  (req, res, next) => {
